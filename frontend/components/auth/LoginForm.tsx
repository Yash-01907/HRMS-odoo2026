        ...
        {mode === "signin" ? (
          ...
          <>
            ...
            <div className="space-y-2">
              ...
              <div className="flex gap-3">
                <input
                  ...
                  className={cn(
                    ...
                    errors.companyName ? "border-rose-500/50" : "border-white/10 focus:border-white/30",
                    "focus:outline-none"
                  )}
                />
              ...
              {errors.companyName && (
                <p className="text-rose-400 text-xs mt-1">{errors.companyName}</p>
              )}
              {formData.companyLogo && (
                <p className="text-white/40 text-xs">Logo: {formData.companyLogo.name}</p>
              )}
            </div>
      ...
      {mode === "signup" && (
        <div className="mt-6 p-4 rounded-lg bg-blue-500/10 border border-blue-500/20">
          <p className="text-blue-400 text-xs leading-relaxed">
            <strong>Note:</strong> Normal users cannot register. When an HR officer or Admin creates a new employee,
            a Login ID will be generated automatically and a password will be auto-generated for first-time login.
