    ...
    <>
      ...
      <div className='flex flex-wrap gap-8 items-start mb-6'>
        <div className='relative'>
          <Avatar className='size-32 border-4 border-white/10 shadow-lg'>
            <AvatarImage src='' alt={profileData.name} />
            <AvatarFallback className='text-2xl bg-gradient-to-br from-blue-500 to-violet-500 text-white'>
              <User className='size-16' />
            </AvatarFallback>
          </Avatar>
          <button className='absolute bottom-0 right-0 p-2 bg-gradient-to-r from-blue-500 to-violet-500 text-white rounded-full hover:opacity-90 transition-opacity border-0'>
