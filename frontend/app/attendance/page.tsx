...
export default function AttendancePage() {
    ...
    return (
        <div className="min-h-screen bg-[#030712]">
            {/* Navigation - Use existing NavigationBar */}
            <nav className="border-b border-white/10 bg-white/[0.02] backdrop-blur-sm px-6 py-4">
                <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <div className="w-9 h-9 rounded-full bg-gradient-to-br from-blue-500 to-violet-500 flex items-center justify-center text-white font-medium">
                            JD
                        </div>
                    </div>
                </div>
